...
(3, 1, 6.8, 8); -- Beatriz - Raciocínio Lógico (cod 1)
 ...
 (6, 1, 27698753);
            ...
            -- Teste de Consultas --
-- 1. RAs, Nomes e Sobrenomes dos Alunos, Nomes dos Cursos e Peíodos das Turmas
...
-- 3. Nomes e sobrenomes dos professores, e disciplinsa que ministram com suas cargas horarioas:
